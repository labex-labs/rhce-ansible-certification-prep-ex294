...
<p align="center">
  <a href="https://labex.io/zh/learn/rhce-ansible">
    <img width="128" src="https://file.labex.io/path/yhXXtMLd7wiu.png" alt="RHCE in Ansible 培训">
  </a>
</p>
...
[在 LabEx 开始学习路径](https://labex.io/zh/learn/rhce-ansible)

**课程**: 3 · **实验**: 58

## 课程

### 1. [RHCE Ansible 实战模拟考试 01](https://labex.io/zh/courses/rhce-ansible-practice-exam-01)
...
|   序号 | 名称                          | 难度   | 练习                                                                                                                                |
|------|-----------------------------|------|-----------------------------------------------------------------------------------------------------------------------------------|
|    1 | 初始化自动化项目仓库                  | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-initialize-an-automation-project-repository-664410?course=rhce-ansible-practice-exam-01)     |
|    2 | 配置 Ansible 和 Navigator 执行环境 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-configure-ansible-and-navigator-execution-664406?course=rhce-ansible-practice-exam-01)       |
|    3 | 使用离线文档完成模块工作流               | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-use-offline-documentation-for-a-module-workflow-664416?course=rhce-ansible-practice-exam-01) |

#### Inventories and Managed Nodes

|   序号 | 名称              | 难度   | 练习                                                                                                                                 |
|------|-----------------|------|------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 构建清单组与主机变量      | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-build-inventory-groups-and-host-variables-664405?course=rhce-ansible-practice-exam-01)        |
|    2 | 配置受管节点访问权限与基准文件 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-configure-managed-node-access-and-baseline-files-664407?course=rhce-ansible-practice-exam-01) |

#### Plays, Playbooks, Modules, and Flow Control

|   序号 | 名称              | 难度   | 练习                                                                                                                               |
|------|-----------------|------|----------------------------------------------------------------------------------------------------------------------------------|
|    1 | 以幂等方式部署服务       | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-deploy-a-service-idempotently-664409?course=rhce-ansible-practice-exam-01)                  |
|    2 | 使用循环和事实应用主机特定逻辑 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-apply-host-specific-logic-with-loops-and-facts-664403?course=rhce-ansible-practice-exam-01) |
|    3 | 修复故障 Playbook   | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-recover-a-faulty-playbook-664413?course=rhce-ansible-practice-exam-01)                      |

#### Variables, Facts, Templates, Vault, and Content

|   序号 | 名称                 | 难度   | 练习                                                                                                                              |
|------|--------------------|------|---------------------------------------------------------------------------------------------------------------------------------|
|    1 | 渲染主机特定的配置模板        | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-render-host-specific-configuration-templates-664414?course=rhce-ansible-practice-exam-01)  |
|    2 | 使用 Vault 保护并部署服务机密 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-protect-and-deploy-service-secrets-with-vault-664412?course=rhce-ansible-practice-exam-01) |
|    3 | 解决事实与变量优先级问题       | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-resolve-facts-and-variable-precedence-664415?course=rhce-ansible-practice-exam-01)         |

#### Roles, Collections, and RHCSA Task Automation

|   序号 | 名称           | 难度   | 练习                                                                                                                          |
|------|--------------|------|-----------------------------------------------------------------------------------------------------------------------------|
|    1 | 创建 Web 服务器角色 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-create-a-web-server-role-664408?course=rhce-ansible-practice-exam-01)                  |
|    2 | 安装并使用暂存的集合内容 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-install-and-use-staged-collection-content-664411?course=rhce-ansible-practice-exam-01) |
|    3 | 自动化多主机管理状态   | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-automate-multi-host-administration-state-664404?course=rhce-ansible-practice-exam-01)  |

### 2. [RHCE Ansible 实战模拟考试 02](https://labex.io/zh/courses/rhce-ansible-practice-exam-02)
...
|   序号 | 名称                 | 难度   | 练习                                                                                                                              |
|------|--------------------|------|---------------------------------------------------------------------------------------------------------------------------------|
|    1 | 修复自动化仓库布局          | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-repair-an-automation-repository-layout-664426?course=rhce-ansible-practice-exam-02)        |
|    2 | 为分段运行时配置 Navigator | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-configure-navigator-for-a-staged-runtime-664420?course=rhce-ansible-practice-exam-02)      |
|    3 | 排查 Ansible 配置优先级问题 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-troubleshoot-ansible-configuration-precedence-664429?course=rhce-ansible-practice-exam-02) |

#### Inventories and Managed Nodes

|   序号 | 名称       | 难度   | 练习                                                                                                                  |
|------|----------|------|---------------------------------------------------------------------------------------------------------------------|
|    1 | 库存中的模型环境 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-model-environments-in-inventory-664422?course=rhce-ansible-practice-exam-02)   |
|    2 | 恢复受管节点连接 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-restore-managed-node-connectivity-664427?course=rhce-ansible-practice-exam-02) |

#### Plays, Playbooks, Modules, and Flow Control

|   序号 | 名称           | 难度   | 练习                                                                                                                             |
|------|--------------|------|--------------------------------------------------------------------------------------------------------------------------------|
|    1 | 配置多服务更新的处理器  | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-configure-handlers-for-multi-service-updates-664419?course=rhce-ansible-practice-exam-02) |
|    2 | 从软件包和任务失败中恢复 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-recover-from-package-and-task-failures-664424?course=rhce-ansible-practice-exam-02)       |
|    3 | 构建条件防火墙与服务规则 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-build-conditional-firewall-and-service-rules-664418?course=rhce-ansible-practice-exam-02) |

#### Variables, Facts, Templates, Vault, and Content

|   序号 | 名称                     | 难度   | 练习                                                                                                                                |
|------|------------------------|------|-----------------------------------------------------------------------------------------------------------------------------------|
|    1 | 使用模板生成应用程序配置           | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-generate-application-configs-from-templates-664421?course=rhce-ansible-practice-exam-02)     |
|    2 | 轮换 Ansible Vault 保护的凭据 | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-rotate-vault-protected-credentials-664428?course=rhce-ansible-practice-exam-02)              |
|    3 | 发布自定义事实并修复变量覆盖         | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-publish-custom-facts-and-fix-variable-overrides-664423?course=rhce-ansible-practice-exam-02) |

#### Roles, Collections, and RHCSA Task Automation

|   序号 | 名称                   | 难度   | 练习                                                                                                                                     |
|------|----------------------|------|----------------------------------------------------------------------------------------------------------------------------------------|
|    1 | 将单体 Playbook 重构为角色   | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-refactor-a-monolithic-playbook-into-roles-664425?course=rhce-ansible-practice-exam-02)            |
|    2 | 使用集合内容进行系统配置         | 中级   | [开始挑战](https://labex.io/zh/labs/rhel-use-collection-content-for-system-configuration-664430?course=rhce-ansible-practice-exam-02)      |
|    3 | 自动化仓库、Web、用户及计划任务合规性 | 高级   | [开始挑战](https://labex.io/zh/labs/rhel-automate-repository-web-user-and-schedule-compliance-664417?course=rhce-ansible-practice-exam-02) |

### 3. [RHCE Ansible 备考指南 (EX294)](https://labex.io/zh/courses/rhce-ansible-prep)
